<template>
  <div class="login">
   <div class="container">
       <img src="../assets/5slmtt09c4ca6tg9bt43lmmqs.jpg" class="avatar">
        <el-form :model="loginForm" :rules="rules" ref="loginForm" class="demo-ruleForm">
      <el-form-item prop="username">
        <el-input v-model="loginForm.username" placeholder='请输入用户名' prefix-icon="myicon-user">
        </el-input>
      </el-form-item>
  ...
  methods: {
    login () {
      this.$refs.loginForm.validate((valid) => {
        ...
        //   console.log('用户数据输入错误')
          this.$message('请输入所有必填数据')
          return false
        }
      })
    }
